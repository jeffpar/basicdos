...
In addition, it's been popular for BASIC to come with its own built-in
full-screen editor, and yet sadly such an editor is usually suitable only for
BASIC files.  What if it could do more?  We know we could ship a really lame
editor, like EDLIN, but maybe we could do better.
